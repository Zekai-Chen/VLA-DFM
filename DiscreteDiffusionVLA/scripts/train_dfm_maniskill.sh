...
# DFM-VLA Supervised Fine-tuning script for ManiSkill2
# Trains on the OXE-converted ManiSkill2 dataset (Franka Panda, 5 tasks).
#
# Usage:
...
# ── Embodiment-specific defaults (ManiSkill2: primary + wrist cameras) ─────
...
# ── Diagnostics ────────────────────────────────────────────────────
echo "========================================="
echo "DFM-VLA Supervised Fine-tuning (ManiSkill2)"
echo "  GPUs: $NPROC"
