...
#SBATCH --job-name=openvla-ft-smoke-3k
#SBATCH --output=logs/openvla_ft_smoke_3k_%j.out
#SBATCH --error=logs/openvla_ft_smoke_3k_%j.err
...
RUN_ROOT_DIR="${BASE_DIR}/checkpoints/ddopenvla-libero-object-smoke-3k"
