...
#SBATCH --job-name=openvla-eval-smoke-3k
#SBATCH --output=logs/openvla_eval_smoke_3k_%j.out
#SBATCH --error=logs/openvla_eval_smoke_3k_%j.err
...
LOG_DIR="${BASE_DIR}/logs/eval_smoke_3k/$(date +'%m%d_%H%M')"
mkdir -p "$LOG_DIR"
