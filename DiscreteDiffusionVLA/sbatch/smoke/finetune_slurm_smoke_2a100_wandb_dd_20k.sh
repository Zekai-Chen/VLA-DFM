...
#SBATCH --job-name=openvla-ft-smoke-20k-dd
#SBATCH --output=logs/openvla_ft_smoke_20k_dd_%j.out
#SBATCH --error=logs/openvla_ft_smoke_20k_dd_%j.err
...
export WANDB_NAME="openvla_ft_smoke_20k_dd_${SLURM_JOBID:-local}"
...
RUN_ROOT_DIR="${BASE_DIR}/checkpoints/ddopenvla-libero-object-smoke-20k"
