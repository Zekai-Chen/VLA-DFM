...
#SBATCH --job-name=openvla-ft-smoke-3k-dd-align
#SBATCH --output=logs/openvla_ft_smoke_3k_dd_align_%j.out
#SBATCH --error=logs/openvla_ft_smoke_3k_dd_align_%j.err
...
export WANDB_NAME="openvla_ft_smoke_3k_dd_align_${SLURM_JOBID:-local}"
...
LEGACY_TRAIN_MODE=${LEGACY_TRAIN_MODE:-False}
