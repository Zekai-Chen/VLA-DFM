...
#SBATCH --job-name=openvla-ft-smoke-20k-tmax-sweep
#SBATCH --output=logs/openvla_ft_smoke_20k_tmax_sweep_%A_%a.out
#SBATCH --error=logs/openvla_ft_smoke_20k_tmax_sweep_%A_%a.err
#SBATCH --array=0-3
...
export WANDB_NAME="openvla_ft_smoke_20k_tmax${DFM_T_MAX_TAG}_${SLURM_JOBID:-local}_${SLURM_ARRAY_TASK_ID:-0}"
