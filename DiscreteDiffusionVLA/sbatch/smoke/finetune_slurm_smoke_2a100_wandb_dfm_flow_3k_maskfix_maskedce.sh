...
#SBATCH --job-name=openvla-ft-smoke-3k-maskfix-maskedce
#SBATCH --output=logs/openvla_ft_smoke_3k_maskfix_maskedce_%j.out
#SBATCH --error=logs/openvla_ft_smoke_3k_maskfix_maskedce_%j.err
