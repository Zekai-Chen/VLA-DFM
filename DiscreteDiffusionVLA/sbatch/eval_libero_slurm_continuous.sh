...
#SBATCH --job-name=openvla-eval-cont
#SBATCH --output=logs/openvla_eval_cont_%j.out
#SBATCH --error=logs/openvla_eval_cont_%j.err
...
LOG_DIR="${BASE_DIR}/logs/continuous_libero_spatial/$(date +'%m%d_%H%M')"
mkdir -p "$LOG_DIR"
...
CHECKPOINT_ROOT="/scratch/ywn1043/VLA-DFM/checkpoints/ddopenvla-libero-object-smoke/openvla-7b+libero_object_no_noops+b2+lr-0.0005+lora-r16+dropout-0.0--smoke-2xA100--20260219_1518"
